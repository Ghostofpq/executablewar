...
echo Starting executablewar-app Adaptor (version 1.0-SNAPSHOT).

set GC_LOG_DIRECTORY="%CD%"\..\logs
mkdir %GC_LOG_DIRECTORY%

set JMX_MANAGEMENT=-Dcom.sun.management.jmxremote
set JMX_MANAGEMENT=%JMX_MANAGEMENT% -Dcom.sun.management.jmxremote.port=29010
...
java %JAVA_OPTS% -jar ../lib/jetty-runner.jar --port 8085 ../lib/executablewar.war